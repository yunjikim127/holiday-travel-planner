...
export class MemStorage implements IStorage {
  ...
  async getHolidays(countryCode: string, year: number): Promise<Holiday[]> {
    ...
    const japaneseHolidays: Holiday[] = [
      { date: "2024-01-01", name: "신정", type: "public", country: "Japan", countryCode: "JP" },
      { date: "2024-01-08", name: "성인의 날", type: "public", country: "Japan", countryCode: "JP" },
      { date: "2024-02-11", name: "건국기념일", type: "public", country: "Japan", countryCode: "JP" },
      { date: "2024-02-12", name: "건국기념일 대체휴일", type: "public", country: "Japan", countryCode: "JP" },
      { date: "2024-02-23", name: "천황탄생일", type: "public", country: "Japan", countryCode: "JP" },
      { date: "2024-03-20", name: "춘분의 날", type: "public", country: "Japan", countryCode: "JP" },
      { date: "2024-04-29", name: "쇼와의 날", type: "public", country: "Japan", countryCode: "JP" },
      { date: "2024-05-03", name: "헌법기념일", type: "public", country: "Japan", countryCode: "JP" },
      { date: "2024-05-04", name: "녹색의 날", type: "public", country: "Japan", countryCode: "JP" },
      { date: "2024-05-05", name: "어린이날", type: "public", country: "Japan", countryCode: "JP" },
      { date: "2024-05-06", name: "대체휴일", type: "public", country: "Japan", countryCode: "JP" },
      { date: "2024-07-15", name: "바다의 날", type: "public", country: "Japan", countryCode: "JP" },
      { date: "2024-08-11", name: "산의 날", type: "public", country: "Japan", countryCode: "JP" },
      { date: "2024-08-12", name: "산의 날 대체휴일", type: "public", country: "Japan", countryCode: "JP" },
      { date: "2024-09-16", name: "경로의 날", type: "public", country: "Japan", countryCode: "JP" },
      { date: "2024-09-22", name: "추분의 날", type: "public", country: "Japan", countryCode: "JP" },
      { date: "2024-09-23", name: "추분의 날 대체휴일", type: "public", country: "Japan", countryCode: "JP" },
      { date: "2024-10-14", name: "스포츠의 날", type: "public", country: "Japan", countryCode: "JP" },
      { date: "2024-11-03", name: "문화의 날", type: "public", country: "Japan", countryCode: "JP" },
      { date: "2024-11-04", name: "문화의 날 대체휴일", type: "public", country: "Japan", countryCode: "JP" },
      { date: "2024-11-23", name: "근로감사의 날", type: "public", country: "Japan", countryCode: "JP" },
    ];

    // Thai holidays for 2024
    const thaiHolidays: Holiday[] = [
      { date: "2024-01-01", name: "신정", type: "public", country: "Thailand", countryCode: "TH" },
      { date: "2024-02-24", name: "마카부차", type: "religious", country: "Thailand", countryCode: "TH" },
      { date: "2024-04-06", name: "차크리 왕조 기념일", type: "public", country: "Thailand", countryCode: "TH" },
      { date: "2024-04-13", name: "송크란 축제", type: "public", country: "Thailand", countryCode: "TH" },
      { date: "2024-04-14", name: "송크란 축제", type: "public", country: "Thailand", countryCode: "TH" },
      { date: "2024-04-15", name: "송크란 축제", type: "public", country: "Thailand", countryCode: "TH" },
      { date: "2024-05-01", name: "노동절", type: "public", country: "Thailand", countryCode: "TH" },
      { date: "2024-05-04", name: "대관식 기념일", type: "public", country: "Thailand", countryCode: "TH" },
      { date: "2024-05-22", name: "위사카부차", type: "religious", country: "Thailand", countryCode: "TH" },
      { date: "2024-07-20", name: "아살라부차", type: "religious", country: "Thailand", countryCode: "TH" },
      { date: "2024-07-28", name: "국왕 탄생일", type: "public", country: "Thailand", countryCode: "TH" },
      { date: "2024-08-12", name: "어머니날", type: "public", country: "Thailand", countryCode: "TH" },
      { date: "2024-10-13", name: "라마 9세 기념일", type: "public", country: "Thailand", countryCode: "TH" },
      { date: "2024-10-23", name: "출라롱콘 대왕 기념일", type: "public", country: "Thailand", countryCode: "TH" },
      { date: "2024-12-05", name: "아버지날", type: "public", country: "Thailand", countryCode: "TH" },
      { date: "2024-12-10", name: "헌법절", type: "public", country: "Thailand", countryCode: "TH" },
      { date: "2024-12-31", name: "섣달그믐", type: "public", country: "Thailand", countryCode: "TH" },
    ];

    // Vietnamese holidays for 2024
    const vietnameseHolidays: Holiday[] = [
      { date: "2024-01-01", name: "신정", type: "public", country: "Vietnam", countryCode: "VN" },
      { date: "2024-02-08", name: "테트 (구정)", type: "public", country: "Vietnam", countryCode: "VN" },
      { date: "2024-02-09", name: "테트 (구정)", type: "public", country: "Vietnam", countryCode: "VN" },
      { date: "2024-02-10", name: "테트 (구정)", type: "public", country: "Vietnam", countryCode: "VN" },
      { date: "2024-02-11", name: "테트 (구정)", type: "public", country: "Vietnam", countryCode: "VN" },
      { date: "2024-02-12", name: "테트 (구정)", type: "public", country: "Vietnam", countryCode: "VN" },
      { date: "2024-02-13", name: "테트 (구정)", type: "public", country: "Vietnam", countryCode: "VN" },
      { date: "2024-02-14", name: "테트 (구정)", type: "public", country: "Vietnam", countryCode: "VN" },
      { date: "2024-04-18", name: "흉왕 기념일", type: "public", country: "Vietnam", countryCode: "VN" },
      { date: "2024-04-30", name: "해방절", type: "public", country: "Vietnam", countryCode: "VN" },
      { date: "2024-05-01", name: "노동절", type: "public", country: "Vietnam", countryCode: "VN" },
      { date: "2024-05-22", name: "부처님 오신 날", type: "religious", country: "Vietnam", countryCode: "VN" },
      { date: "2024-09-02", name: "국경일", type: "public", country: "Vietnam", countryCode: "VN" },
      { date: "2024-09-03", name: "국경일", type: "public", country: "Vietnam", countryCode: "VN" },
    ];

    // US holidays for 2024
    const usHolidays: Holiday[] = [
      { date: "2024-01-01", name: "신정", type: "public", country: "United States", countryCode: "US" },
      { date: "2024-01-15", name: "마틴 루터 킹 데이", type: "public", country: "United States", countryCode: "US" },
      { date: "2024-02-19", name: "대통령의 날", type: "public", country: "United States", countryCode: "US" },
      { date: "2024-05-27", name: "현충일", type: "public", country: "United States", countryCode: "US" },
      { date: "2024-06-19", name: "준틴스", type: "public", country: "United States", countryCode: "US" },
      { date: "2024-07-04", name: "독립기념일", type: "public", country: "United States", countryCode: "US" },
      { date: "2024-09-02", name: "노동절", type: "public", country: "United States", countryCode: "US" },
      { date: "2024-10-14", name: "콜럼버스 데이", type: "public", country: "United States", countryCode: "US" },
      { date: "2024-11-11", name: "재향군인의 날", type: "public", country: "United States", countryCode: "US" },
      { date: "2024-11-28", name: "추수감사절", type: "public", country: "United States", countryCode: "US" },
      { date: "2024-12-25", name: "크리스마스", type: "public", country: "United States", countryCode: "US" },
    ];
